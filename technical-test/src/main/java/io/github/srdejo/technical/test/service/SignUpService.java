...
public interface SignUpService {
     ...
     *   <li>Creates and persists a new {@link io.github.srdejo.technical.test.entities.User} entity from the request data.</li>
     ...
     * @throws io.github.srdejo.technical.test.exceptions.UserAlreadyExistsException if a user with the given email is already registered.
     */
